...
public class TreeTest {
	...
	public void children() {
		...
		Position<Integer> p;
		int i = 1;
		Queue<Position<Integer>> cola = new QueueEnlazada<Position<Integer>>();
		try {
			p = T.root();
	...
	public void addBefore() {
		...
		try {
			...
			hijosH1 = new ListaDobleEnlazada<Integer>();
			hijosH1.addFirst(4);
			hijosH1.addFirst(5);
			hjsH1 = new ListaDobleEnlazada<Integer>();
	...
	public void addAfter() {
		...
		try {
			...
			chequearPadre(T.root());
			// caso de prueba para los hijos de root
			PositionList<Integer> hijosRoot = new ListaDobleEnlazada<Integer>();
			hijosRoot.addFirst(2);
			hijosRoot.addFirst(7);
			hijosRoot.addFirst(3);
			hijosRoot.addFirst(6);
			hijosRoot.addFirst(9);
			PositionList<Integer> hijos = new ListaDobleEnlazada<Integer>();
			for (Position<Integer> n : T.children(T.root())) {
	...
	public void remove() {
		...
		T = getTree();
		cargarArbol2(T);
		lista = new ListaDobleEnlazada<Position<Integer>>();
		try {
